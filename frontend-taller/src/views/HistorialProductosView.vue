<template>
  <div class="py-6 sm:py-8 px-3 sm:px-4 mx-auto max-w-screen-2xl lg:px-6">
    <div class="relative bg-white dark:bg-gray-800 sm:rounded-lg overflow-hidden">
      ...
      <div class="flex flex-col md:flex-row items-start md:items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
        ...
        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
          ...
          <input 
            ...
            placeholder="Año"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full sm:w-32 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
      </div>
        ...
        <table class="w-full min-w-[980px] text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr v-for="registro in historialPaginado" :key="registro.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
              ...
              <td class="px-6 py-4">
                {{
                  `${registro.Vehiculo?.marcaVehiculo?.nombre || 'Sin marca'} - ${registro.Vehiculo?.modeloVehiculo?.nombre || 'Sin modelo'} (${registro.Vehiculo?.anio || 'S/A'})`
                }}
              </td>
      ...
      <!-- Paginación -->
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 p-4">
        ...
        <div class="flex space-x-2 overflow-x-auto max-w-full pb-1">
          <button
